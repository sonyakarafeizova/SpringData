...
@Column(name="exploring_from")
    ...
    private Volcano exploredVolcano;
    ...
    public Volcano getExploredVolcano() {
        return exploredVolcano;
    }

    public void setExploredVolcano(Volcano exploredVolcano) {
        this.exploredVolcano = exploredVolcano;
    }
}
